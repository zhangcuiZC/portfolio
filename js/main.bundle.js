		...
		var $col = $(".col"),
			...
			colclose = function() {
				if(!flag) {
					...
					if(idx === 1) {
						var closecol1=setTimeout(function(){
							self.find('.col2-img').removeClass('active');
						}, 600);
					}

					if(idx === 3) {
						var closecol3=setTimeout(function(){
					...
					if(idx === 2) {
						...
						var closecol2=setTimeout(function(){
